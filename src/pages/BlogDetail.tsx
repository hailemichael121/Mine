...
import { blogPosts, BlogContentBlock } from "../components/blogsSec/blogsData";
        ...
        {!post ? (
          ...
          <VStack align="start" spacing={{ base: 6, md: 8 }}>
            <Box
              ...
              overflow="hidden"
            >
              <Image src={post.image} alt={post.title} w="100%" h="320px" objectFit="cover" />
            </Box>
            ...
            <VStack align="start" spacing={3} w="100%">
              ...
              <HStack spacing={4} color={baseColor} opacity={0.7} fontSize="sm">
                <Text>{post.date}</Text>
                <Divider orientation="vertical" height="12px" borderColor={baseColor} />
