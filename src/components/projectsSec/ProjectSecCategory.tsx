...
const ProjectSecCategory: React.FC<Props> = ({
  ...
  const subtleBg =
    colorMode === "light" ? "rgba(38, 38, 38, 0.08)" : "rgba(255, 255, 255, 0.08)";
            ...
            {categories.map((category) => (
              ...
              >
                ...
                <Badge
                  ...
                  color={activeCategory === category.name ? surfaceColor : baseColor}
                >
                  {category.count}
                </Badge>
              </MenuItem>
          ...
          >
            ...
            >
              ...
              <Badge
                ...
                border="1px solid"
                borderColor={baseColor}
                bg={activeCategory === category.name ? surfaceColor : "transparent"}
